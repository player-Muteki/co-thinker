...
```powershell
# 方式一（推荐 - 使用 curl.exe）
powershell -ExecutionPolicy Bypass -c 'iex (((curl.exe -sSL https://raw.githubusercontent.com/player-Muteki/co-thinker/main/install.ps1) -join [char]10).TrimStart([char]0xFEFF))'
